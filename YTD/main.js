...
function download() {
  if (link.value != "") {    
    ...
    if (link.value.indexOf("https://youtu.be/") != -1) {
      ...
      r1.innerHTML = `<iframe id="myframe" width="100%" height="100%" src="${url1}" encrypted-media; allowfullscreen></iframe>`;
      ...
      r1.innerHTML = `<iframe id="myframe" width="100%" height="100%" src="${u3}" encrypted-media; allowfullscreen></iframe>`;
